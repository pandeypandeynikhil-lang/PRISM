...
class RetentionStrategy(Base):
    ...
    strategy_type = Column(String)         # offer, outreach, product_recommendation, fee_waiver
    channel = Column(String)               # email, sms, phone, in_app, branch
    priority = Column(Integer, default=1)  # 1=urgent, 2=high, 3=medium
    ...
    status = Column(String, default="pending")  # pending, sent, accepted, rejected, expired
